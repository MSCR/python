class Restaurant:
    ...
    def describe_restaurant(self):
        ...
        print(f"\nThis is the restauran {self.restaurant_name.title()} speceialize on {self.cuisine_type} cuisine.")
...
your_restaurant = Restaurant("El compa", "indu")
your_restaurant.describe_restaurant()
your_restaurant.open_restaurant()

his_restaurant = Restaurant("Il tavolo", "mexican")
